...
from .exceptions import OAuthError, TokenExpiredError, InvalidTokenError
...
class RPRAuth:
    ...
    def __init__(self, app=None, user_class=OAuthUser, login_view='auth.login', 
    ...
    def _register_routes(self, app):
        ...
        def callback():
            ...
            try:
                ...
                twofa_validated = token.get('twofa_validated', False) or userinfo.get('twofa_validated', False)
